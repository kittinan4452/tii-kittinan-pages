export default function Yourself(){
    ...
    return(
      ...
      <a href="/image/resume_kittinan.pdf" download="resume_kittinan.pdf" className="bg-gray-300 hover:bg-gray-400 text-gray-800   font-bold py-2 px-4 rounded inline-flex items-center mt-5 animate-bounce">
