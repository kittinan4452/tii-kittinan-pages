           ...
           <h1 className="text-5xl text-center text-red-700 mb-6 mt-12  stroke-gray-300">Experiences</h1>
            <div className="flex flex-wrap md:space-x-5 max-lg:justify-center lg:justify-center lg:space-x-10 xl:justify-start xl:space-x-4 space-y-5 max-md:justify-center max-md:space-y-5 ">
                ...
                <figure className="pt-4">
                    ...
                    src="/image/HealthCalendar/calendar.jpg"
                    alt="Shoes" />
                </figure>
                <div className="card-body">
                ...
                <figure className="pt-4">
                    ...
                    src="/image/projectclude/projectclude.jpg"
                    alt="Shoes" />
                </figure>
                <div className="card-body">
                ...
                <figure className="pt-4">
                    ...
                    src="/image/esp32cam/esp32cam-ml.jpg"
                    alt="Shoes" />
                </figure>
                <div className="card-body">
...
<dialog id="my_modal_1" className="modal ">
  <div className="modal-box w-11/12 max-w-5xl bg-[#1D232A] text-white">
    ...
    <Image src="/image/playsmart1.jpg" width={600} height={600} className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <Image src="/image/platsmartbook.jpg" width={600} height={600}  />
...
<dialog id="my_modal_2" className="modal  ">
  <div className="modal-box w-11/12 max-w-5xl bg-[#1D232A] text-white">
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <Image src="/image/rice/ricelogin.png" width={600} height={600} className="rounded-md"  />
    <p className="text-left">Login page to use the Web Application to check rice quality.</p>
    </div> 
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <Image src="/image/rice/ricesignup.jpg" width={600} height={600}  />
    <p>Registration page in order to apply for membership in use webapplication.</p>
    </div>
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <Image src="/image/rice/ricewebhomepage.jpg" width={600} height={600}  />
    <p>Registration page in order to apply for membership in use webapplication.</p>
    </div>
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <Image src="/image/rice/riceshowlist.jpg" width={600} height={600}  />
    <p>The page shows completed items in a table format, with a delete button and a view details button.</p>
    </div>
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <Image src="/image/rice/ricewebshowdata.jpg" width={600} height={600}  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <Image src="/image/rice/ricedetect.jpg" width={600} height={600}  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <Image src="/image/rice/riceposter.jpg" width={600} height={600}  />
...
<dialog id="my_modal_3" className="modal  ">
  <div className="modal-box w-11/12 max-w-5xl bg-[#1D232A] text-white ">
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/HealthCalendar/calendar.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/HealthCalendar/calendar5.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/HealthCalendar/calendar6.jpg" className="rounded-md"  />
    <p>The program can change the background color as the user desires.</p>
    </div>
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/HealthCalendar/calendar7.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/HealthCalendar/calendar2.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/HealthCalendar/calendar3.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/HealthCalendar/calendar8.jpg" className="rounded-md"  />
...
<dialog id="my_modal_4" className="modal  ">
  <div className="modal-box w-11/12 max-w-5xl bg-[#1D232A] text-white">
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/projectclude/projectclude.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/projectclude/projectclude1.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/projectclude/projectclude2.jpg" className="rounded-md"  />
    <p>The web application can also add up to 4 form pages to select different banks.</p>
    </div>
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/projectclude/projectclude3.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/projectclude/projectclude4.jpg" className="rounded-md"  />
    <p>The page shows all the details of the Web Application of from number one.</p>
    </div>
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/projectclude/projectclude5.jpg" className="rounded-md"  />
...
<dialog id="my_modal_5" className="modal  ">
  <div className="modal-box w-11/12 max-w-5xl bg-[#1D232A] text-white ">
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/esp32cam/esp32cam-ml1.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/esp32cam/esp32cam-ml2.jpg" className="rounded-md"  />
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/esp32cam/esp32cam-ml3.jpg" className="rounded-md"  />
...
<dialog id="my_modal_6" className="modal  ">
  <div className="modal-box w-11/12 max-w-5xl bg-[#1D232A] text-white ">
    ...
    <div className="justify-center flex flex-col items-center space-y-4 mt-5">
    <img src="/image/ics-test/1.jpg" className="rounded-md"  />
